...
function generateURL(role: Role, id: string, pass: string): string {
	...
	if (role == Role.Receiver) {
		...
		// we can safely assume average network RTT to be <200ms on non-congested networks, as 4G has now become widespread and 3G is phased out in most countries; see https://hpbn.co/mobile-networks/#cellular-performance and https://en.wikipedia.org/wiki/3G#Phase-out
	}
