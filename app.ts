...
function generateURL(role: Role, id: string, pass: string): string {
	...
	if (role == Role.Receiver) {
		...
		url.searchParams.set("jitterBufferTarget", String(400)); // buffer must be at least 1.5x RTT (may require 2x RTT depending on receiver implementation) for retransmissions to work; see https://www.rtcbits.com/2017/03/retransmissions-in-webrtc.html
