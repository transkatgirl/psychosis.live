...
function helperMenu() {
	...
	document.body.innerHTML =
		'<h1>psychosis.live</h1><p>This service allows you to stream <em>end-to-end encrypted</em> video from your smartphone into OBS over practically any internet connection (>125 kbit/s), allowing you to stream anything from almost anywhere.</p><p>Unlike similar services, such as <a href="https://vdo.ninja">VDO.Ninja</a>, psychosis.live focuses on <em>both</em> preserving watchability over poor connections and delivering the highest quality possible over good connections.</p><p>It is strongly recommended that you <b>use Google Chrome on both sides of the connection</b> for the best possible experience, as WebRTC implementations vary significantly between browsers. Both <a href="https://bugzilla.mozilla.org/show_bug.cgi?id=1728573">Firefox</a> and <a href="https://bugs.webkit.org/show_bug.cgi?id=211192">iOS Safari</a> have serious (for this use-case) known issues in their WebRTC implementations.</p>';
