...
function generateURL(role: Role, id: string, pass: string): string {
	...
	if (role == Role.Receiver) {
		...
		- Retransmissions take 1.5 * RTT. If the buffer is too small, lost packets can't be retransmitted in time, significantly worsening user experience (see https://www.rtcbits.com/2017/03/retransmissions-in-webrtc.html)
			- https://hpbn.co/mobile-networks/#cellular-performance discusses latency on non-congested cellular networks. Keep in mind that 3G is phased out or in the process of being phased out in most countries (see https://en.wikipedia.org/wiki/3G#Phase-out).
