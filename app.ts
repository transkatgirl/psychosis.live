		...
		if (
			...
			if (!scaler) {
				if (!width || !height) {
					...
					scaler = new MediaScaler(width, height, "mks2013");
				} else {
					scaler = new MediaScaler(width, height, "mks2013");
